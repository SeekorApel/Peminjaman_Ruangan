...
{
    public partial class UpdateDendaKerusakanRuangan : Form
    {
        string idDendaKerusakanTemp, deskripsiKerusakanTemp, biayaDendaTemp;
        public UpdateDendaKerusakanRuangan(string idDendaKerusakan, string deskripsiKerusakan, string biayaDenda)
        {
            InitializeComponent();
        ...
        private void UpdateDendaKerusakanRuangan_Load(object sender, EventArgs e)
        {
        ...
        private void updateDB()
        {
            try
            {
                ...
                SqlCommand sqlcmd = new SqlCommand("sp_updateDendaKerusakanRuangan", connection);
                ...
                sqlcmd.Parameters.AddWithValue("@idDendaKerusakanRuangan", idDendaKerusakanTemp);
