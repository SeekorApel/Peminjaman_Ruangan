...
{
    public partial class InputDendaKerusakanBarang : Form
    {
        public InputDendaKerusakanBarang()
        {
            InitializeComponent();
        }

        private void InputDendaKerusakanBarang_Load(object sender, EventArgs e)
        {
        ...
        private void inputDB()
        {
            ...
            try
            {
                ...
                SqlCommand sqlcmd = new SqlCommand("sp_inputDendaKerusakanBarang", connection);
                sqlcmd.CommandType = CommandType.StoredProcedure;

                string query = "SELECT TOP 1 idDendaKerusakanBarang FROM DendaKerusakanBarang ORDER BY idDendaKerusakanBarang DESC";

                sqlcmd.Parameters.AddWithValue("@idDendaKerusakanBarang", autogenerateID("DKB", query));
