...
namespace SpaceSolutions {
    ...
    public partial class DSUser : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UserRow AddUserRow(string idUser, string nama, string username, string password, string noTelp, string jabatan, int role, int status) {
...
namespace SpaceSolutions.DSUserTableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[User] WHERE (([idUser] = @Original_idUser) AND ((@IsNull_nama = 1 AND [nama] IS NULL) OR ([nama] = @Original_nama)) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_noTelp = 1 AND [noTelp] IS NULL) OR ([noTelp] = @Original_noTelp)) AND ((@IsNull_jabatan = 1 AND [jabatan] IS NULL) OR ([jabatan] = @Original_jabatan)) AND ((@IsNull_role = 1 AND [role] IS NULL) OR ([role] = @Original_role)) AND ((@IsNull_status = 1 AND [status] IS NULL) OR ([status] = @Original_status)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[User] ([idUser], [nama], [username], [password], [noTelp], [jabatan], [role], [status]) VALUES (@idUser, @nama, @username, @password, @noTelp, @jabatan, @role, @status);
SELECT idUser, nama, username, password, noTelp, jabatan, role, status FROM [User] WHERE (idUser = @idUser)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[User] SET [idUser] = @idUser, [nama] = @nama, [username] = @username, [password] = @password, [noTelp] = @noTelp, [jabatan] = @jabatan, [role] = @role, [status] = @status WHERE (([idUser] = @Original_idUser) AND ((@IsNull_nama = 1 AND [nama] IS NULL) OR ([nama] = @Original_nama)) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_noTelp = 1 AND [noTelp] IS NULL) OR ([noTelp] = @Original_noTelp)) AND ((@IsNull_jabatan = 1 AND [jabatan] IS NULL) OR ([jabatan] = @Original_jabatan)) AND ((@IsNull_role = 1 AND [role] IS NULL) OR ([role] = @Original_role)) AND ((@IsNull_status = 1 AND [status] IS NULL) OR ([status] = @Original_status)));
SELECT idUser, nama, username, password, noTelp, jabatan, role, status FROM [User] WHERE (idUser = @idUser)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idUser, nama, username, password, noTelp, jabatan, role, status FROM dbo.[" +
                "User]";
        ...
        public virtual int Delete(string Original_idUser, string Original_nama, string Original_username, string Original_password, string Original_noTelp, string Original_jabatan, global::System.Nullable<int> Original_role, global::System.Nullable<int> Original_status) {
        ...
        public virtual int Insert(string idUser, string nama, string username, string password, string noTelp, string jabatan, global::System.Nullable<int> role, global::System.Nullable<int> status) {
            if ((idUser == null)) {
        ...
        public virtual int Update(
            ...
            if ((noTelp == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(noTelp));
            }
            if ((jabatan == null)) {
            ...
            if ((Original_idUser == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_idUser));
            }
            if ((Original_nama == null)) {
            ...
            if ((Original_jabatan == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((string)(Original_jabatan));
            }
            if ((Original_role.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nama, string username, string password, string noTelp, string jabatan, global::System.Nullable<int> role, global::System.Nullable<int> status, string Original_idUser, string Original_nama, string Original_username, string Original_password, string Original_noTelp, string Original_jabatan, global::System.Nullable<int> Original_role, global::System.Nullable<int> Original_status) {
            return this.Update(Original_idUser, nama, username, password, noTelp, jabatan, role, status, Original_idUser, Original_nama, Original_username, Original_password, Original_noTelp, Original_jabatan, Original_role, Original_status);
        }
    }
